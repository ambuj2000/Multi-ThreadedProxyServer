...
// int proxy_socket;                  // Socket descriptor of proxy server
// pthread_t client_threads[MAX_CONNECTIONS]; // Array to store thread IDs of clients
// sem_t client_semaphore;            // Semaphore for client request limit
// pthread_mutex_t cache_lock;        // Mutex lock for cache

// cache_node* cache_head = NULL;     // Pointer to the head of the cache
// int current_cache_size = 0;        // Current size of the cache
